...
{
    sudo cp -v template_gunicorn.conf /etc/supervisor/conf.d/
    sudo cp -v template_gunicorn.conf /etc/supervisor/conf.d/
...
{
    sudo cp -v template_botDjango.service /etc/systemd/system/
    sudo systemctl enable template_botDjango.service
    sudo systemctl start template_botDjango.service
...
{
    sudo cp -v manage_command_cron_timetable /etc/cron.d/
